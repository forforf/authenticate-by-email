...
module.exports = function(config) {
  ...
  return {
    ...
    verify: function(email, randomStr, challengeResponse, cb){
      var record = authConfig.model.get((email));
      var errorMsg = {error: 'Not verified'};
      ...
      var isVerified = (record.response === challengeResponse &&
        record.randomStr === randomStr);
